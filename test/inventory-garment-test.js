...
it("#01. garment-inventory-movement should valid", function () {
    ...
    validate.inventoryMovement(new GarmentInventoryMovement());
});
...
it("#02. garment-inventory-summary should valid", function () {
    ...
    validate.inventorySummary(new GarmentInventorySummary());
});
...
it("#03. garment-inventory document should valid", function () {
    ...
    validate.inventoryDocument(new GarmentInventoryDocument());
});