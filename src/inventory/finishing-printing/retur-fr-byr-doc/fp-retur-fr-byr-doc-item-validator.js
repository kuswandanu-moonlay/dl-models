...
module.exports = function (data) {
    ...
    data.should.have.property('productDescription');
    data.productDescription.should.instanceof(String);

    data.should.have.property("hasNewProduct");
    data.hasNewProduct.should.instanceOf(Boolean);
